            ...
            <div className="mt-4">
              <div id="notificationContainer" className="notification-container">
                {currentNotifications.map((notification, index) => (
                  <div key={index} className="notification-item text-white p-5 rounded-[20px] shadow-lg mb-6 cursor-pointer" style={{ background: 'linear-gradient(160deg, #C62828 65%, #FF7733 100%)' }}>
